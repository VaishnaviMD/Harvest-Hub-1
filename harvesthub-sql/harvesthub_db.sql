...
--
-- Host: localhost    Database: harvesthub_db
-- ------------------------------------------------------
...
CREATE TABLE `delivery` (
  `del_id` bigint NOT NULL AUTO_INCREMENT,
  `actual_del_time` datetime(6) DEFAULT NULL,
  `del_person` varchar(255) DEFAULT NULL,
  `distance` double DEFAULT NULL,
  `est_del_time` datetime(6) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `order_id` bigint NOT NULL,
  PRIMARY KEY (`del_id`),
  UNIQUE KEY `UK_3bdrbd2jcybaaa5rxkj4s7vlk` (`order_id`),
  CONSTRAINT `FKu4e8rjwmg09vmas3ccjwglso` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
...
CREATE TABLE `feedback` (
  ...
  `date_of_feedback` datetime(6) DEFAULT NULL,
...
CREATE TABLE `payment` (
  ...
  `mode_of_pay` varchar(255) DEFAULT NULL,
  `pay_date` datetime(6) DEFAULT NULL,
  `pay_gateway` varchar(255) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `date_of_harvest` datetime(6) DEFAULT NULL,
  `freshness` double DEFAULT NULL,
  ...
  CONSTRAINT `FKrh8ldn7kusub8s0oraf2dh4sj` FOREIGN KEY (`farmer_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'test@example.com','City','Test User','pass','1234567890',NULL,'Customer');
...
-- Dump completed on 2025-11-12 17:10:32
